...
public final class CalculatorQuickAffordanceConfig implements KeyguardQuickAffordanceConfig {
    ...
    public static final String KEY = "fundamental_calculator";
    ...
    public int getPickerIconResourceId() {
        return R.drawable.fundamental_ic_calculator_lockscreen;
    }

    @Override
    public String pickerName() {
        return mContext.getString(R.string.fundamental_quick_affordance_calculator_label);
    }
    ...
    public Flow getLockScreenState() {
        ...
        if (isTargetAvailable()) {
            state = new LockScreenState.Visible(
                    new Icon.Resource(
                            R.drawable.fundamental_ic_calculator_lockscreen,
                            new ContentDescription.Resource(
                                    R.string.fundamental_quick_affordance_calculator_label)),
