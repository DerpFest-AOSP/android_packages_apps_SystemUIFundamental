...
public final class CalendarQuickAffordanceConfig implements KeyguardQuickAffordanceConfig {
    ...
    public static final String KEY = "fundamental_calendar";
    ...
    public int getPickerIconResourceId() {
        return R.drawable.fundamental_ic_calendar_lockscreen;
    }

    @Override
    public String pickerName() {
        return mContext.getString(R.string.fundamental_quick_affordance_calendar_label);
    }
    ...
    public Flow getLockScreenState() {
        ...
        if (isTargetAvailable()) {
            state = new LockScreenState.Visible(
                    new Icon.Resource(
                            R.drawable.fundamental_ic_calendar_lockscreen,
                            new ContentDescription.Resource(
                                    R.string.fundamental_quick_affordance_calendar_label)),
